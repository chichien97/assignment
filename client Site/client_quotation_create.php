    ...
    <div class="main">
      ...
      <div class="q-container col-lg-12">
        ...
        <div class="q-cust-container col-lg-12">
          <form action="../php/quotation_add.php" method="post">
            <div class="q-cust-left col-lg-6">
              ...
              <div class="add-cust-container">
                ...
                <input type="date" name="dateStart" class="cust-input">
              </div>
              <div class="add-cust-container">
                <label>Date End</label>
                <input type="date" name="dateEnd" class="cust-input">
              </div>
              <input type="hidden" name="totalAmount" value="<?php echo $t;?>" readonly>
              <button type="submit" class="btn btn-create"><i class='fa fa-file-text btn-icon'></i>Create</button>
            </div>
          ...
          <form action ="../php/quotation_add_item.php?quotation_No=<?php echo $qno;?>" method="post">
            <table class="table table-bordered product-table" id="pTable">
              <thead>
                ...
                <th class="col-lg-6" colspan="2">Product : Description<i class="fa fa-plus add-btn" style="float:right;margin-top:0.3em" onclick="openAdd_p()"></i></th>
