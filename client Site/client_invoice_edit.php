...
if (mysqli_num_rows($res) > 0) {
  ...
  $ino = $row["invoice_No"];
  $cslc = "SELECT * FROM client_customer WHERE customer_ID='".$row["customer_ID"]."'";
    ...
    <div class="main">
      ...
      <div class="i-container">
          ...
          <div class="i-input-container col-lg-12"> <!-- EITHER EDIT OR REMOVE EXTRA CONTAINER JUST IN CASE -->
            <form action="../php/invoice_update.php" method="post">
              <!-- Left side section -->
              <div class="i-left">
                <div class="i-input">
                  <input type="hidden" name="ino" value="<?php echo $ino;?>">
                  <label>Customer Name</label>
                  <input type="text" list="customer_list" name="cust_name" class="cust-input" value="<?php echo $cRow["customer_Name"]?>" placeholder="Enter Customer Name" id="cust_name">
                ...
                <div class="i-input">
                  ...
                  <input type="date" name="invoiceDate" value="<?php echo $row["invoice_Date"]?>" placeholder="Invoice Date" required>
                </div>
                <div class="i-input">
                  <label>Payment Due</label>
                  <input type="date" name="paymentDue"  value="<?php echo $row["payment_Due"]?>" placeholder="Payment Due" required>
                </div>
