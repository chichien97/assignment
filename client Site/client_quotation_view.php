    ...
    <div class="main">
      ...
      <div class="q-container">
        ...
        <div class="qView-btn">
          ...
          <button class="btn btn-edit" onclick="location.href='client_quotation_edit.php?quotation_ID=<?php echo $_GET["quotation_ID"];?>'"><i class="far fa-edit btn-icon"></i>Edit</button>
        </div>
        <!-- Invoice Content -->
        <div class="qView-content">
          <!-- Content Header -->
          <!-- <div> -->
            <h4 style="margin-bottom:1.0rem">Quotation No: <?php echo $row["quotation_No"]; ?></h4>
          <!-- </div> -->
          <!-- Content Body -->
          <div>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                $slc3 = "SELECT * FROM client_quotation_item WHERE quotation_No = $qno";
